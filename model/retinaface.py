...
class RetinaFace(nn.Module):
    ...
    def forward(self, x):
        ...
        # Head
        class_head=torch.cat([self.class_head1(feature1),self.class_head2(feature2),self.class_head3(feature3)],dim=1)
        bbox_head=torch.cat([self.bbox_head1(feature1),self.bbox_head2(feature2),self.bbox_head3(feature3)],dim=1)
        landmark_head=torch.cat([self.landmarks_head1(feature1),self.landmarks_head2(feature2),self.landmarks_head3(feature3)],dim=1)
